class City {
  ...
  factory City.fromJson(Map<String, String> map) {
    return City(
        id: map[cityId],
        ar: map[cityNameAr],
        en: map[cityNameEn],
        governId: map[cityGovernId]);
  }

  City getCity({required String key, required String value}) {
    Map<String, String> map = cities.firstWhere((e) => e[key] == value);
    return City.fromJson(map);
  }

  List<City> getCities({required String key, required String value}) {
    List cities1 = cities.where((e) => e[key] == value).toList();
    List<City> myCities = [];
    myCities.clear();
    for (var city in cities1) {
      myCities.add(City.fromJson(city));
    }
    return myCities;
  }
}

const String cityId = 'id';
const String cityNameAr = 'city_name_ar';
const String cityNameEn = 'city_name_en';
const String cityGovernId = 'governorate_id';
...
class Governorate {
  ...
  Governorate({this.id, this.ar, this.en});

  factory Governorate.fromJson(Map<String, String> map) {
    return Governorate(
        id: map[governorateId],
        ar: map[governorateNameAr],
        en: map[governorateNameEn]);
  }

  Governorate getGovernorate({required String key, required String value}) {
    Map<String, String> map = governorates.firstWhere((e) => e[key] == value);
    return Governorate.fromJson(map);
  }

  List<Governorate> getGovernorates() {
    List<Governorate> myGovernorates = [];
    myGovernorates.clear();
    for (var governorate in governorates) {
      myGovernorates.add(Governorate.fromJson(governorate));
    }
    return myGovernorates;
  }
}

const String governorateId = 'id';
const String governorateNameAr = 'governorate_name_ar';
const String governorateNameEn = 'governorate_name_en';
List governorates = [
